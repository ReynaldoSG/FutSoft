...
namespace marcatel_api.Controllers
{
    ...
    public class UbicacionesController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
        public JsonResult InsertUbicacion([FromBody] InsertUbicacionesModel ubi)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _UbicacionService.InsertUbicacion(ubi);
        ...
        {
            var objectResponse = Helper.GetStructResponse();
            ResponseUbicacion result = new ResponseUbicacion();
            result.Response = new ResponseBodyUbicacion();
            result.Response.data = new List<GetUbicacionesModel>();

            var UbicacionResponse = _UbicacionService.GetUbicacion();

            if (UbicacionResponse != null && UbicacionResponse.Any())
            {
                ...
                result.Response.data = UbicacionResponse;
                objectResponse.response = new
                {
        ...
        [HttpPut("Update")]
        public JsonResult UpdateUbicaciones([FromBody] UpdateUbicacionesModel ubi)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _UbicacionService.UpdateUbicaciones(ubi);
        ...
        [HttpPut("Delete")]
        public JsonResult DeleteUbicaciones([FromBody] DeleteUbicacionesModel ubi)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var catClienteResponse = _UbicacionService.DeleteUbicaciones(ubi);
