...
namespace marcatel_api.Controllers
{
    ...
    public class LigaController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
public JsonResult InsertLiga([FromBody] InsertLigaModel liga)
{
    var objectResponse = Helper.GetStructResponse();
    try
    {
        var catClienteResponse = _LigaService.InsertLiga(liga);
...
//}
        ...
        [HttpGet("Get")]
        public IActionResult GetLiga() 
        {
            var objectResponse = Helper.GetStructResponse();
            ResponseLiga result = new ResponseLiga();
            result.Response = new ResponseBodyLiga();
            result.Response.data = new List<GetLigaModel>();

            var LigaResponse = _LigaService.GetLiga();
        ...
        [HttpPut("Update")]
        public JsonResult UpdateLiga([FromBody] UpdateLigaModel liga)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _LigaService.UpdateLiga(liga);
        ...
        [HttpPut("Delete")]
public JsonResult DeleteLiga([FromBody] DeleteLigaModel liga)
{
    var objectResponse = Helper.GetStructResponse();
    try
    {
        var catClienteResponse = _LigaService.DeleteLiga(liga);
