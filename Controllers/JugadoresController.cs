...
namespace marcatel_api.Controllers
{
    ...
    public class JugadoresController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
public JsonResult InsertJugadores([FromBody] InsertJugadoresModel jugadores)
{
    var objectResponse = Helper.GetStructResponse();
    try
    {
        var catClienteResponse = _JugadoresService.InsertJugadores(jugadores);
...
//}
        ...
        {
            var objectResponse = Helper.GetStructResponse();
            ResponseJugadores result = new ResponseJugadores();
            result.Response = new ResponseBodyJugadores();
            result.Response.data = new List<GetJugadoresModel>();

            var JugadoresResponse = _JugadoresService.GetJugadores();

            if (JugadoresResponse != null && JugadoresResponse.Any())
            {
                ...
                result.Response.data = JugadoresResponse;
                objectResponse.response = new
                {
        ...
        [HttpPut("Update")]
        public JsonResult UpdateJugadores([FromBody] UpdateJugadoresModel jugadores)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _JugadoresService.UpdateJugadores(jugadores);
        ...
        [HttpPut("Delete")]
public JsonResult DeleteJugadores([FromBody] DeleteJugadoresModel jugadores)
{
    var objectResponse = Helper.GetStructResponse();
    try
    {
        var catClienteResponse = _JugadoresService.DeleteJugadores(jugadores);
