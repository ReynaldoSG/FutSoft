...
namespace marcatel_api.Controllers
{
    ...
    public class DTController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
        public JsonResult InsertDT([FromBody] InsertDTModel dt)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _dtService.InsertDT(dt);
        ...
        {
            var objectResponse = Helper.GetStructResponse();
            ResponseDT result = new ResponseDT();
            result.Response = new ResponseBodyDT();
            result.Response.data = new List<GetDTModel>();

            var ResponseDT = _dtService.GetDT();

            if (ResponseDT != null && ResponseDT.Any())
            {
                ...
                result.Response.data = ResponseDT;
                objectResponse.response = new
                {
        ...
        [HttpPut("Update")]
        public JsonResult UpdateDT([FromBody] UpdateDTModel dt)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _dtService.UpdateDT(dt);
            ...
            return new JsonResult(objectResponse);
                ...
                [HttpPut("Delete")]
public JsonResult DeleteDT([FromBody] DeleteDTModel dt)
{
    var objectResponse = Helper.GetStructResponse();
    try
    {
        var catClienteResponse = _dtService.DeleteDT(dt);
